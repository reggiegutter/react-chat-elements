...
export class MessageBox extends React.PureComponent {
    ...
    render() {
        ...
        var thatAbsoluteTime =
            !/(text|video|file|meeting|audio)/g.test(this.props.type) &&
            !(this.props.type === "location" && this.props.text);

        const dateText =
            this.props.date &&
            !isNaN(this.props.date) &&
            (this.props.dateString || format(this.props.date, "pt_BR"));
                            ...
                            {this.props.type === "meeting" &&
                                this.props.meeting && (
                                    <MeetingMessage
                                        ...
                                        dateString={
                                            this.props.meeting.dateString
                                        }
                                        collapseTitle={
                                            this.props.meeting.collapseTitle
                                        }
                                        participants={
                                        ...
                                        dataSource={
                                            this.props.meeting.dataSource
                                        }
                                        onClick={
                                            this.props.onMeetingMessageClick
                                        }
                                        onMeetingMoreSelect={
                                            this.props.onMeetingMoreSelect
                                        }
                                        onMeetingVideoLinkClick={
                                            this.props.onMeetingVideoLinkClick
                                        }
                                        onMeetingTitleClick={
                                            this.props.onMeetingTitleClick
                                        }
                                    />
                                )}
